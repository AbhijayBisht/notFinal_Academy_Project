package com.cts.Academy.configuration;
...
@ComponentScans(value={@ComponentScan("com.cts.Academy.dao"),
		@ComponentScan("com.cts.Academy.service")
})
public class AppConfig {
	...
	properties.put(org.hibernate.cfg.AvailableSettings.C3P0_MIN_SIZE, 
  	...
  	sessionFactoryBean.setPackagesToScan("com.cts.Academy.bean");
